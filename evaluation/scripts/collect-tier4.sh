...
WORK_DIR="$(mktemp -d -t redundant-branching-tier4.XXXXXX)"
...
# Tutorial/learning oriented repositories with substantial TypeScript examples.
REPOS=(
...
echo "=== Collecting Tier 4 (Tutorial / Learning) ==="
...
if [ "$files_collected" -eq 0 ]; then
  echo "ERROR: No files were collected for Tier 4." >&2
  exit 1
fi
...
echo
echo "=== Tier 4 collection complete ==="
